...
def setup_db():
    ...
    channel = Channel(id=id_channel, name="RSS", module="superform.plugins.slack", config="{}")
...
class TestLiveServer:
    def test_basic(self, client):
        ...
        driver.find_element_by_link_text("RSS").click()

        assert driver.find_element_by_id("RSS_titlepost").get_attribute(
            "value") == "Test"
        assert driver.find_element_by_id("RSS_descriptionpost").get_attribute(
            "value") == "Frontend"
        assert driver.find_element_by_id("RSS_linkurlpost").get_attribute(
    ...
    def test_basic_moderate(self, client):
        ...
        driver.find_element_by_link_text("RSS").click()
        extra = {}
        pub = Publishing(post_id=id_post, channel_id=id_channel, state=0, title=driver.find_element_by_id("RSS_titlepost").get_attribute("value"),
                         description=driver.find_element_by_id("RSS_descriptionpost").get_attribute("value"),
                         link_url=driver.find_element_by_id("RSS_linkurlpost").get_attribute("value"),
                         image_url="pas",
    ...
    def test_basic_warning(self, client):
        ...
        pub = Publishing(post_id=id_post, channel_id=id_channel, state=0,
                         title=driver.find_element_by_id("RSS_titlepost").get_attribute("value"),
                         description=driver.find_element_by_id("RSS_descriptionpost").get_attribute("value"),
                         link_url=driver.find_element_by_id("RSS_linkurlpost").get_attribute("value"),
                         image_url="pas",
    ...
    def test_basic_publish(self, client):
        ...
        driver.find_element_by_id("channel name").click()
        driver.find_element_by_id("channel name").clear()
        driver.find_element_by_id("channel name").send_keys("general")
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='channel name'])[1]/following::button[1]").click()
